        ...
        <Grid centered>
          <Grid.Row>
            ...
            <Grid.Column computer={6} tablet={6} mobile={6}>
              <Header>{userName} has signed up for {coursesNumber} {courseString} with {credits} credits</Header>
                    ...
                    <Table.Body>
                        { favsDivs.map((c, index) =>
                          <Table.Row>
                            ...
                            <Button onClick={
                                    (e) => {
                                        var state = this.props.removeFav(c._id);
                                        this.setState(state);
                                    }
                                      }>Remove</Button>
                            </Table.Cell>
